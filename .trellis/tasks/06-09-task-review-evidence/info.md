...
task data/evidence model, frontend task detail, trace/evidence files
...
Task evidence spec: screenshots, trace/API/DB proof, notes, review/reopen record, evidence persistence.
...
```text
REAL_task_review_evidence_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_task_review_evidence_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
