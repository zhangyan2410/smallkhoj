...
frontend/app/globals.css, frontend/components/ui, shared style tokens
...
Design-system spec: cyan/blue identity, neutral operational surfaces, reusable status/list/tab/message/task patterns.
...
```text
REAL_frontend_design_system_cyan_blue_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_frontend_design_system_cyan_blue_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
