...
frontend/app/members/page.tsx, member/computer/workspace APIs
...
Member detail spec: humans/agents list, selected detail, Profile/Permissions/DMs/Reminders/Workspace/Apps/Activity tabs.
...
```text
REAL_members_agent_profile_tabs_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_members_agent_profile_tabs_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
