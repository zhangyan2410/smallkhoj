...
const buttonVariants = cva(
  /* 手作风：直角 + 墨色硬描边。focus 用 inset ring 中海蓝。 */
  "group/button inline-flex shrink-0 items-center justify-center rounded-none border-2 border-[var(--ink)] bg-clip-padding text-sm font-medium whitespace-nowrap transition-colors outline-none select-none focus-visible:ring-2 focus-visible:ring-ring/60 focus-visible:ring-inset active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        /* 实色中海蓝 + 墨色硬描边。hover 加硬阴影（贴纸感）。 */
        default:
          "bg-primary text-primary-foreground hover:shadow-[2px_2px_0_var(--ink)]",
        outline:
