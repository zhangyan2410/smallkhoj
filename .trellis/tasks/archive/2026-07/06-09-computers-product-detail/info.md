...
frontend/app/computers/page.tsx, computer/workspace/daemon APIs
...
Computer detail spec: selected computer, runtimes, daemon version, workspaces, agents, scan, connect/reconnect, delete safety.
...
```text
REAL_computers_product_detail_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_computers_product_detail_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
