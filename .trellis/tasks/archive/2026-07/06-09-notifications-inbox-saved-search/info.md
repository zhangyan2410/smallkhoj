...
event records, search APIs, saved/reaction/task/message state, app shell nav
...
Attention layer spec: notification center, activity inbox, saved items, global search, actionable source links.
...
```text
REAL_notifications_inbox_saved_search_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_notifications_inbox_saved_search_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
