...
activity logs, daemon/runtime trace, member detail activity tab
...
Activity diagnostics spec: lifecycle summary, recent deliveries/actions/errors, raw logs behind expandable details.
...
```text
REAL_agent_activity_diagnostics_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_agent_activity_diagnostics_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
