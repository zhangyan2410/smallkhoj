...
.trellis/workflow.md, .trellis/spec/frontend/quality-guidelines.md, .trellis/spec/backend/runtime-slock-integration.md, docs/real-runtime-dm-reply-sop.md
...
Trellis process spec: real browser/runtime tests are a quality gate for browser-facing and runtime/control-plane work.
...
```text
REAL_trellis_real_test_quality_gate_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_trellis_real_test_quality_gate_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
