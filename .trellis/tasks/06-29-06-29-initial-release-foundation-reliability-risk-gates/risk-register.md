...
| FR-11 | P1 | Daemon version skew | Old daemon connects but protocol behavior is incompatible | accepted warning for first release; follow-up minimum-version handshake under daemon distribution task | `06-29-06-29-initial-release-daemon-distribution-versioning` | warn |
...
P0 foundation ready. Latest coherent gate run on 2026-06-29 produced 0 failed checks, 0 blocked checks, 0 warnings, and `ready=true`.
...
- P1/P2 risks FR-09 through FR-15 remain visible as accepted first-release warnings or follow-up tasks. They do not block the P0 foundation gate, but they should be revisited as soon as real usage starts.
...
- FR-11 daemon version skew: accepted for the first release because the distribution artifact and command shape exist, but minimum-version protocol enforcement remains follow-up. Escalate once more than one daemon version may be in circulation.
