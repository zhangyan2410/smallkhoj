...
test("Main page object taxonomy documents and preserves aligned object classes", () => {
  const design = readFileSync(
    join(frontendRoot, "..", ".trellis/tasks/06-30-ink-wash-theme-exploration/design.md"),
    "utf8"
  )
  const languageMap = readFileSync(
    join(frontendRoot, "..", ".trellis/tasks/06-30-ink-wash-theme-exploration/visual-language-map.md"),
    "utf8"
  )
  const alignmentNotes = readFileSync(
    join(frontendRoot, "..", ".trellis/tasks/06-30-ink-wash-theme-exploration/object-language-alignment.md"),
    "utf8"
  )
  const chatSources = [
