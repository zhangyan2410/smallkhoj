...
frontend/app/tasks/page.tsx, task APIs, channel/member APIs
...
Tasks spec: board/list, filters, cards, detail, status transitions, source channel/message references.
...
```text
REAL_tasks_board_list_filters_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_tasks_board_list_filters_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
