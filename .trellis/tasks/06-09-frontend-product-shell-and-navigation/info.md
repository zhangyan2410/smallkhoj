...
frontend/app/layout.tsx, frontend/app/page.tsx, shared app-shell components, navigation routes
...
Product shell/navigation spec: app-first screen, persistent first-level navigation, context sidebar slots, responsive no-overlap layout.
...
```text
REAL_frontend_product_shell_and_navigation_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_frontend_product_shell_and_navigation_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
