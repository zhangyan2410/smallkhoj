...
frontend/app/chat/[channel]/channel-client.tsx, message reaction/save/task APIs
...
Message action spec: stable controls for thread, reaction, save, as-task, copy/menu with keyboard/focus support.
...
```text
REAL_message_actions_thread_reactions_saved_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_message_actions_thread_reactions_saved_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
