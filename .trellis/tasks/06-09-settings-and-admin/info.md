...
frontend/app/settings/**, account/server/provider/admin APIs
...
Settings spec: server/user settings, runtime defaults, feature flags, admin links, confirmations for destructive controls.
...
```text
REAL_settings_and_admin_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_settings_and_admin_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
