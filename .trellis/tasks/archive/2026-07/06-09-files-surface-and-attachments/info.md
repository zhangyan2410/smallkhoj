...
frontend/app/chat/**, frontend file surface, backend files/attachments APIs
...
Files spec: conversation Files tab, attachment controls, metadata rows, source message links, safe errors.
...
```text
REAL_files_surface_and_attachments_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_files_surface_and_attachments_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
