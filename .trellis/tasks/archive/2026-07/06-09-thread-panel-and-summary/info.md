...
frontend/app/chat/[channel]/channel-client.tsx, backend thread APIs, threading contracts
...
Thread spec: root context, replies, reply count, summary/status, parent_id/threadId/DM target correctness.
...
```text
REAL_thread_panel_and_summary_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_thread_panel_and_summary_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
