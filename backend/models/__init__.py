...
from .slock import (
    ...
    Task, TaskAssignment, TaskRun, MemoryEntry, MemoryProposal, ActivityLog, EventRecord, FileEntry, SavedItem, MessageReaction, Reminder, ApiKey,
    ConnectTicket,
)
...
__all__ = [
    ...
    "Message", "ThreadSummary", "Task", "TaskAssignment", "TaskRun", "MemoryEntry", "MemoryProposal", "ActivityLog", "EventRecord", "FileEntry", "MessageReaction",
