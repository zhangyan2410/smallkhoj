...
frontend/app/chat/**, frontend/lib/control-plane.ts, channel/message APIs
...
Chat surface spec: Activity/Saved/Channels/DM sidebar, conversation tabs, message stream, composer, task/files entry points.
...
```text
REAL_chat_product_surface_<YYYYMMDDHHMMSS>
```
...
8. Write `evidence/REAL_chat_product_surface_<timestamp>-notes.md` with commands run, pass/fail, and remaining gaps.
